...
\begin{tabular}{|M{0.8cm}|p{2.2cm}|p{5.7cm}|M{1.8cm}|p{2.2cm}|}
  ...
  \hline
  0.5 & Giuliano Banchieri & Stesura sezione architettura di deployment e organizzazione container & 21/04/2026 & - \\
  \hline
...
La scelta della tipologia di \textbf{architettura di deployment} è stata guidata dal contesto di utilizzo del prodotto e dai requisiti di scalabilità previsti dal capitolato.
Non avendo ricevuto indicazioni specifiche riguardo a vincoli di deployment, il team ha optato per un'\textbf{architettura monolitica}. Questa soluzione, oltre ad essere in linea con le esigenze del prodotto, semplifica la fase di progettazione e sviluppo ed evita la complessità introdotta da un'architettura a microservizi, non giustificata dalle esigenze del progetto.
