...
\begin{tabular}{|M{0.8cm}|p{2.2cm}|p{5.7cm}|M{1.8cm}|p{2.2cm}|}
  ...
  \hline
  0.8 & Niccolò Feltrin & Aggiornata sezione architettura logica frontend (sezione 3.2) & 12/05/2026 & - \\
  \hline
...
\subparagraph{NavButton} Bottone che rappresenta una chiamata all'azione - segnala all'utente un'operazione da compiere.
\subparagraph{NavItem} Bottone che rappresenta una destinazione di navigazione - segnala all'utente dove si trova nell'applicazione (la route attiva). Quando il link corrisponde alla rotta corrente, viene applicato uno stile visivo distinto, che funge da indicatore di posizione nella navigazione.
