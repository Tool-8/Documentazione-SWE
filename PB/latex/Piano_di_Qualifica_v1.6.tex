...
\begin{longtable}{|l|p{8cm}|p{2cm}|p{1.5cm}|}
    ...
    \testI & Verificare che POST /api/llm restituisca 422 con errore "Translation in selected\_language is not supported" quando viene fornita una lingua non supportata per la traduzione - verificato da \texttt{LlmTest.php} & S \\ \hline
