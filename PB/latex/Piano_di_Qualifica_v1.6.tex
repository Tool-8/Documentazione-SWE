...
\begin{longtable}{|l|p{8cm}|p{2cm}|p{1.5cm}|}
    ...
    \testI & Verificare che GET /api/notes/export/\{id\}?format=wrong_format restituisca 400 con messaggio "Unknown format: wrong_format" quando viene richiesto un formato non valido con id - verificato da \texttt{ExportTest.php} & S \\ \hline
    \testI & Verificare che POST /api/notes/export restituisca 400 con messaggio "Unknown format: wrong_format" quando viene richiesto un formato non valido senza id - verificato da \texttt{ExportTest.php} & S \\ \hline
    ...
    \testI  & Verificare che POST /api/notes/import restituisca 400 con messaggio "uploaded_format format is not supported" quando il file caricato ha un formato non supportato - verificato da \texttt{ImportTest.php} & S \\ \hline
    ...
    \testI & Verificare che POST /api/llm restituisca 422 con errore "Translation in selected_language is not supported" quando viene fornita una lingua non supportata per la traduzione - verificato da \texttt{LlmTest.php} & S \\ \hline
