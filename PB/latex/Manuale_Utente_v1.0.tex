...
\begin{tabular}{|M{0.8cm}|p{2.2cm}|p{5.7cm}|M{1.8cm}|p{2.2cm}|}
  ...
  1.0 & Spadiliero Ruben & Approvazione documento per PB & 14/05/206 & Gabriele Disa \\
    \hline
  0.5 & Gabriele Disa & Riscrittura sezione 3 & 12/05/2026 & Besnik Murtezan \\
    \hline
...
Di seguito vengono presentate in dettaglio le funzionalità fornite all'interno dell'editor.
  ...
  \begin{center}
    \begin{figure}[H]
      \centering
      \includegraphics[width=0.3\textwidth]{resources/manual/editor/aside_riassumi.png}
      \hspace{1cm}
      \includegraphics[width=0.3\textwidth]{resources/manual/editor/aside_riassumi_risultato.png}
  ...
  \paragraph{\fcolorbox{black}{blue!15}{Traduci}}
    ...
    \texttt{Italiano | Inglese (default) | Francese | Tedesco | Spagnolo}
