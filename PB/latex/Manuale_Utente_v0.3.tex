...
\begin{tabular}{|M{0.8cm}|p{2.2cm}|p{5.7cm}|M{1.8cm}|p{2.2cm}|}
  ...
  \textbf{Ver.} & \textbf{Autore} & \textbf{Modifiche} & \textbf{Data} & \textbf{Verifica} \\
    \hline
  0.4 & Besnik Murtezan & Stesura sezioni 4.2 & 08/05/2026 & - \\
    \hline
...
Di seguito vengono presentate in dettaglio le funzionalità fornite all'interno dell'editor:
  ...
  \paragraph{\fcolorbox{black}{blue!15}{Riassumi}}
    ...
    Cliccando sul relativo bottone \fcolorbox{black}{cyan!50}{Riassumi}, verrà aperta la sezione riguardante l'interazione con LLM. All'interno è possibile visualizzare il testo selezionato, il bottone di esecuzione ed il risultato (inizialmente vuoto). 
    In fondo sono inoltre presenti i pulsanti per aggiungere automaticamente il risultato al contenuto della nota, in relazione alla posizione del testo selezionato:
  ...
  \paragraph{\fcolorbox{black}{blue!15}{Critica}}
    ...
    Cliccando sulla relativa opzione \fcolorbox{black}{cyan!50}{Critica} 

  \paragraph{\fcolorbox{black}{blue!15}{Traduci}}

    Cliccando sulla relativa opzione \fcolorbox{black}{cyan!50}{Traduci}

  \paragraph{\fcolorbox{black}{blue!15}{Riscrivi}}

    Cliccando sulla relativa opzione \fcolorbox{black}{cyan!50}{Riscrivi}

  \paragraph{\fcolorbox{black}{blue!15}{Distant Writing}}

    Cliccando sulla relativa opzione \fcolorbox{black}{cyan!50}{Distant Writing}
  ...
  Le modifiche effettuate al contenuto della nota vengono tracciate in modo da permettere all'utente di ripristinare rapidamente l'effetto
  I due pulsanti presenti nella barra in alto a sinistra (elemento \#8 nella \autoref{fig:editor_note}) servono rispettivamente per:
    ...
    \begin{figure}[H]
      \centering
      \includegraphics[width=0.5\textwidth]{resources/manual/editor/UNDO-REDO.png}
  ...
  L'utente può quindi decide quale azione eseguire per risolvere la differenza tra le proprie modifiche e quelle presenti in archivio. Le azioni possibili sono:
    \begin{itemize}
