...
\begin{itemize}
    \item Conferma della scelta del capitolato$^G$ C6 e discussione riguardante:
    \begin{itemize}
        \item Domande da porre all'azienda per comprendere meglio gli obbiettivi e le richieste del capitolato$^G$
...
Abbiamo stilato una lista di domande da porre al referente dell'azienda durante un eventuale meeting organizzato:\begin{itemize}
    ...
    \item Possibilità di utilizzare API$^G$ di DeepL per la componente di traduzione del testo
...
\section*{To-Do}
\begin{itemize}
    \item Contattare via mail il referente dell'azienda del capitolato$^G$ C6
