...
\begin{tabular}{|M{1cm}|p{3cm}|p{7cm}|M{1.8cm}|}
  ...
  \hline
  1.0 & Niccolò Feltrin & Conferma del documento & 30/10/2025 \\
  \hline
...
\begin{itemize}
    ...
    \end{itemize}
    \item Documento candidatura$^G$
    \begin{itemize}
        \item 	Predisposizione file relativo al documento di candidatura$^G$ e  inizio redazione contenuti, in particolare la motivazione della nostra scelta
    \end{itemize}
\end{itemize}

\section*{Conclusioni}
Abbiamo portato a termine tutti gli obiettivi posti a inizio riunione, terminando l'analisi dei costi e iniziando con la stesura della candidatura$^G$

\section*{To-Do}
\begin{itemize}
    \par
    \item Terminare il documento di candidatura$^G$
\end{itemize}
