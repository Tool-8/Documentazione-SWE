...
\begin{tabular}{|M{0.8cm}|p{3cm}|p{4.1cm}|M{1.8cm}|p{3cm}|}
  ...
  \hline
  0.2 & Stefano Maso & Aggiornamento Cruscotto di valutazione a seguito del terzo sprint & 17/02/2026 & - \\
  \hline
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{resources/EAC.png}
...
\end{figure}
Il gruppo deve impegnarsi come sta facendo per mantenere la \textit{Cost Variance}, la \textit{Schedule Variance} e la \textit{Budget Variance} all'interno dei limiti accettabili. Al termine del terzo sprint tutte e tre le metriche hanno valori accettabili.
