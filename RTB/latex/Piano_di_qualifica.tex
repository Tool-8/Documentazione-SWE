...
\begin{tabular}{|M{0.8cm}|p{3cm}|p{4.1cm}|M{1.8cm}|p{3cm}|}
  ...
  \hline
  0.1 & Stefano Maso & Stesura struttura documento e prime sezioni & \slashdate{\displaydate{dataverbale}} & - \\
  \hline
\end{tabular}
\label{tab:revisioni}
\end{table}
...
\begin{itemize}
    \item Lezione \textit{Progettazione Software (T6)} del corso di \textit{Ingegneria del software}: \\ \url{https://www.math.unipd.it/~tullio/IS-1/2025/Dispense/T06.pdf}
...
\textbf{Analisi dei Requisiti} Per l'attività di \textit{Analisi dei Requisiti} definiamo le seguenti metriche:
\begin{itemize}
...
\section{Testing}
In questa sezione verranno esplorate le metodologie di testing e la loro specifica. L'obiettivo è seguire il "\textit{Modello a V}", in cui ad ogni fase di sviluppo corrisponde un tipo di test da eseguire.\\
