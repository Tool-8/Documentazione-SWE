...
\begin{tabular}{|M{0.8cm}|p{3cm}|p{4.1cm}|M{1.8cm}|p{3cm}|}
  ...
  \hline
  0.4 & Niccolò Feltrin & Aggiornato calcolo indice di Gulpease in AdR (v1.0) e verbale interno 3/3/2026, aggiunti test di sistema & 10/03/2026 & - \\
  \hline
...
\end{figure}
Il grafico illustra l'andamento delle tre varianze nei quattro sprint: al termine del terzo sprint si osserva un avvicinamento di CV e BV al limite inferiore, dovuto al periodo di sessione universitaria parzialmente previsto; la SV rimane è rimasta stabile, suggerendo che il team ha deliberatamente pianificato meno lavoro in quel periodo per far fronte alla sessione, contenendo il ritardo sulla pianificazione a scapito però dell'efficienza economica. Nel quarto sprint CV e BV recuperano correttamente, tuttavia la SV mostra un leggero decremento, indicando che il rallentamento del terzo sprint non è stato pienamente recuperato in termini di valore prodotto; il team dovrà colmare questo ritardo nei periodi successivi.
...
\end{figure}
Il grafico illustra i valori dell'Indice di Gulpease calcolati per i documenti relativi alla milestone$^G$ RTB: Analisi dei Requisiti, Norme di Progetto, Piano di Progetto e Piano di Qualifica. Tutti i documenti superano abbondantemente la soglia minima di 40 punti. In particolare, l'Analisi dei Requisiti registra un valore particolarmente elevato, riconducibile alla natura stessa del documento, caratterizzato da una struttura ricca di elementi grafici (Casi d'uso) e da un uso esteso di elenchi puntati, fattori che incidono positivamente sul calcolo dell'indice.
