...
Siamo il gruppo 15 \textit{Tool-8} del corso di Ingegneria del Software dell'anno 2025/26, composto dai seguenti membri: \\
\begin{center}
...
Con la presente lettera, il gruppo \textbf{Tool-8} vuole candidarsi alla revisione di avanzamento \texttt{Technology Requirements Baseline} (RTB) per il progetto \textbf{Second Brain} proposto dall'azienda \textit{Zucchetti}.

\vspace{1\baselineskip}

La documentazione per la RTB è costituita da:
\begin{itemize}
...
\end{itemize}
La relativa repository è consultabile all'indirizzo:\\
\href{https://github.com/Tool-8/Documentazione-SWE}{\underline{\texttt{https://github.com/Tool-8/Documentazione-SWE}}}

\vspace{1\baselineskip}

Per una visualizzazione più accessibile dei documenti, è disponibile il sito fornito da GitHub Pages all'indirizzo:\\ \href{https://tool-8.github.io/Documentazione-SWE/}{\underline{\texttt{https://tool-8.github.io/Documentazione-SWE/}}}

\vspace{2\baselineskip}

Il \textbf{Proof of Concept} invece è contenuto nella repository consultabile al seguente indirizzo:\\
